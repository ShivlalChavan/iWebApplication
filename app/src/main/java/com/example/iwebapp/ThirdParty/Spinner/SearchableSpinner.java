        ...
        SearchableListDialog.SearchableItem, Serializable
{
    ...
    private void init()
    {
        ...
        if (!TextUtils.isEmpty(_strHintText))
        {
            ArrayAdapter arrayAdapter = new ArrayAdapter(_context, R.layout
                    .spinner_row, new String[]{_strHintText});
            _isFromInit = true;
        ...
        if (event.getAction() == MotionEvent.ACTION_UP)
        {
            ...
            if (null != _arrayAdapter)
            {
                ...
                for (int i = 1; i < _arrayAdapter.getCount(); i++)
                {
                    ...
                    if (_arrayAdapter.getItem(i) instanceof YearPOJO)
                    {
                        _items.add(((YearPOJO) _arrayAdapter.getItem(i))
                                .getYearName());
                    }
                    else if (_arrayAdapter.getItem(i) instanceof MonthsPOJO)
                    {
                        _items.add(((MonthsPOJO) _arrayAdapter.getItem(i))
                                .getMonthName());
                    }
                ...
                // Change end.
                /*else if (_arrayAdapter.getItem(i) instanceof CompanyPOJO)
                    {
                        _items.add(((CompanyPOJO) _arrayAdapter.getItem(i))
                                .getCompanyName());
                    }*/
    ...
    {
        setSelection(_items.indexOf(item) + 1);
    ...
    public void setSearchHint(String _strHintText)
    {
        _searchableListDialog.setSearchHint(_strHintText);
    }
