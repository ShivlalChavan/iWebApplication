package com.example.iwebapp.ThirdParty.Spinner;
        ...
        SearchView.OnQueryTextListener, SearchView.OnCloseListener, Serializable
{
    ...
    private String _strTitle,_strHintText;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState)
    {
        ...
        String strHint = _strHintText == null ? "Search Here" : _strHintText;
        _searchView.setQueryHint(strHint);
        ...
        window1.clearFlags(WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams.FLAG_ALT_FOCUSABLE_IM);
    ...
    private void setData(View rootView)
    {
        ...
        listAdapter = new ArrayAdapter(getActivity(), R.layout.spinner_row,
                items);
        ...
        _listViewItems.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                {
                    _searchableItem
                            .onSearchableItemClicked(listAdapter.getItem(position), position + 1);
                }
                else if ((position + 1) >= listAdapter.getCount())
                {
                    _searchableItem.onSearchableItemClicked(listAdapter
